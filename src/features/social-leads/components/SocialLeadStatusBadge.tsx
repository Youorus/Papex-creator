...
import { LeadContactStatus } from "../types";
...
const statusMap: Record<LeadContactStatus, { label: string; className: string }> = {
  ...
  CONTACTED: { label: "Contacté", className: "bg-violet-500/10 text-violet-500 border-violet-500/20" },
  ...
  CONVERTED: { label: "Converti", className: "bg-cyan-500/10 text-cyan-500 border-cyan-500/20" },
