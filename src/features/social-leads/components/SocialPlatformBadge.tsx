...
const platformMap: Record<SocialPlatform, { label: string; icon: any; className: string }> = {
  TIKTOK: { label: "TikTok", icon: Video, className: "bg-black text-[#ff0050] border-black" },
  INSTAGRAM: { label: "Instagram", icon: Instagram, className: "bg-gradient-to-tr from-orange-400 to-pink-600 text-white border-transparent" },
  YOUTUBE: { label: "YouTube", icon: Youtube, className: "bg-red-600 text-white border-transparent" },
